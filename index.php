<?php
  ...
  if(isset($_GET['city'])){
    ...
    $urlContent = file_get_contents('https://api.openweathermap.org/data/2.5/weather?q='.$_GET['city'].'&units=metric&appid=e26fbcf1d6e728a5a2bd51c9a23b2dcd'.'&lang={ru}');

    https://api.openweathermap.org/data/2.5/weather?q=.$_GET['city'].{city}&appid={9b5a560357860c2653a753d8d83d8b40}
